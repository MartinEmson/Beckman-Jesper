...
var __assign = function() {
  return __assign = Object.assign || function __assign2(t2) {
    for (var e2, i = 1, o = arguments.length; i < o; i++)
      for (var s in e2 = arguments[i])
...
var Animate = class {
  advance(t2) {
    ...
    let e2 = false;
    if (this.lerp)
      this.value = function damp(t3, e3, i, o) {
...
var Emitter = class {
  ...
  emit(t2, ...e2) {
    ...
    for (let t3 = 0, o = i.length; t3 < o; t3++)
      i[t3](...e2);
  }
  on(t2, e2) {
    var _a;
...
var e = function() {
  function Lenis(t2) {
    ...
    this.__isSmooth = false, this.__isScrolling = false, this.__isStopped = false, this.__isLocked = false, this.onVirtualScroll = function(t3) {
      ...
      if (!o2.ctrlKey) {
        ...
        if (P.options.syncTouch && s2 && "touchstart" === o2.type && !P.isStopped && !P.isLocked)
          P.reset();
        else {
          ...
          if (!r2 && !l2) {
            ...
            if (!(h2 = h2.slice(0, h2.indexOf(P.rootElement))).find(function(t4) {
              ...
              if (P.isStopped || P.isLocked)
                ...
                if (P.isSmooth = P.options.syncTouch && s2 || P.options.smoothWheel && n2, !P.isSmooth)
  ...
  return Lenis.prototype.destroy = function() {
    ...
    if (!this.isStopped && !this.isLocked || S) {
      ...
      if ("number" == typeof t2) {
        if (t2 += n, t2 = Math.round(t2), this.options.infinite ? y && (this.targetScroll = this.animatedScroll = this.scroll) : t2 = clamp(0, t2, this.limit), l)
...
//# sourceMappingURL=chunk-QQPUQYLM.js.map
